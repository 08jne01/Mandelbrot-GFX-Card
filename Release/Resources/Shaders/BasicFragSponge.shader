...

{
...

	{
		...
		vec3 n4 = normalize(vec3(cos(angle), arrows.y, sin(angle)));
	...
	//mat4 rot1 = rotationMatrix(vec3(0, 1, 0), arrows.x);
	//-0.251
	//mat4 rot2 = rotationMatrix(normalize(vec3(0, 0, 0)), 2.*PI/3.);
	...
	*/
	...
	//float s1 = sphere(p, vec4(1.0, 1.0, 1.0, 0.25));
